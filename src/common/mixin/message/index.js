...
mixin.methods.$apiError = function (e) {
  e.data && this.$error(e.data.msg)
  e.response && this.$error(e.response.data.msg)
}
mixin.methods.$info = (msg, title, opts = {}) => {
  return MessageBox.alert(msg, title, opts)
}
mixin.methods.$apiError = function (e) {
  if (e.data) {
